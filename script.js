...
(_a = document.getElementById('resumeForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) {
    ...
    var allElements = nameElement && emailElement && profilePictureInput && phoneElement && cityElement && professionalSummaryElement && educationElement && experienceElement && skillsElement;
    if (allElements) {
