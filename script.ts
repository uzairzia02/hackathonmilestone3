...
document.getElementById('resumeForm')?.addEventListener('submit', function(event) {
  ...
  let allElements = nameElement && emailElement && profilePictureInput && phoneElement && cityElement && professionalSummaryElement && educationElement && experienceElement && skillsElement
  if(allElements) {
